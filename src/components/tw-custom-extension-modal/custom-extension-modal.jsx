...
const CustomExtensionModal = props => (
    ...
    >
        ...
        >
            ...
            {!props.developerMode && (props.onChangeUnsandboxed ? (
                <React.Fragment>
                    ...
                    {props.unsandboxed && (
                        <p className={styles.unsandboxedWarning}>
                            <FormattedMessage
                                defaultMessage={
                                    'Loading extensions without the sandbox is dangerous and should not be enabled ' +
                            ...
                            <FormattedMessage
                                defaultMessage={
                                    'Unsandboxed extensions can corrupt your project, delete your settings, ' +
                                    'phish for passwords, and other bad things. ' +
                                    'The {APP_NAME} developers are not responsible ' +
                ...
                <p className={styles.trustedExtension}>
                    <FormattedMessage
                        defaultMessage={
                            'This extension will be loaded without the sandbox because it is from a trusted source.'
                        }
                        description="Message that appears in custom extension prompt"
                ...
                <p>
                    <FormattedMessage
                        defaultMessage={
                            'Extensions from untrusted URLs will always be loaded with the sandbox for security.'
                        }
                        description="Message that appears in custom extension prompt"
