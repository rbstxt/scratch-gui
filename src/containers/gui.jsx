...
const mapStateToProps = state => {
    ...
    const notesTabEnabled = Boolean(state.scratchGui.preferences.notesTab);
    const activeTabIndex = !notesTabEnabled && rawActiveTabIndex === NOTES_TAB_INDEX ?
        BLOCKS_TAB_INDEX : rawActiveTabIndex;
    return {
        activeTabIndex,
